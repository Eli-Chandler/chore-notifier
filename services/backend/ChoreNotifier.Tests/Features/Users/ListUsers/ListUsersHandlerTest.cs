...
public class ListUsersHandlerTest : DatabaseTestBase
{
    ...
    {
        // Arrange & Act
        var result = await _handler.Handle(new ListUsersRequest(10, null));
    ...
    public async Task Handle_WhenUsersExist_ReturnsAllUsers(int userCount)
    {
        ...
        // Act
        var result = await _handler.Handle(new ListUsersRequest(20, null));
    ...
    public async Task Handle_WhenPageSizeSmallerThanTotal_ReturnsPaginatedResults()
    {
        ...
        // Act
        var result = await _handler.Handle(new ListUsersRequest(5, null));
    ...
    public async Task Handle_WhenUsingCursor_ReturnsRemainingUsers()
    {
        ...
        // Act - Get first page
        var firstPage = await _handler.Handle(new ListUsersRequest(5, null));

        // Act - Get second page using cursor
        var secondPage = await _handler.Handle(new ListUsersRequest(5, firstPage.Value.NextCursor));
    ...
    {
        // Arrange & Act
        var result = await _handler.Handle(new ListUsersRequest(0, null));
    ...
    {
        // Arrange & Act
        var result = await _handler.Handle(new ListUsersRequest(-1, null));
    ...
    {
        // Arrange & Act
        var result = await _handler.Handle(new ListUsersRequest(101, null));
